...
namespace OnnxRuntime.ResNet.Template
{
    class Program
    {
        ...
        {
            // Read paths
            string modelFilePath = @"C:\Users\zeroc\Source\repos\onnxruntime-csharp-cv-template\model\resnet50v2.onnx";
            string imageFilePath = @"C:\Users\zeroc\Source\repos\onnxruntime-csharp-cv-template\data\test3.jpg";
